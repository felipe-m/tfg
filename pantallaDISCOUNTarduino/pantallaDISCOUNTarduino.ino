...
LiquidCrystal lcd(16,17,23,25,27,29);
      #define BEEPER 37           // Beeper and is Connected into GADGETS3D shield MEGA_18BEEPER
...
void setup() {
      ...
      pinMode(BTN_EN1,INPUT_PULLUP);// Encoder left direction
      pinMode(BTN_EN2,INPUT_PULLUP);// Encoder right direction
