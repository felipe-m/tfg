...
//variables internas
      bool btn_en1,btn_en2,btn_enc,btn_en1_prev,btn_en2_prev ;               //variables de lectura di_Xrecta del encoder
      ...
      int i,j,k= 0 ;                                                      // di_Xversos contadores
      int volatile di_X,di_Y,df_X,df_Y = 0;                                               // variables del ensayo (di_Xstancia inicial, di_Xstancia final, velocidad)
      int pagina = 1;
      long x, x_mm, y, y_mm = 0 ;                                                      // variable de la di_Xstancia puntual (en micras)
      int t = 5;
void setup() {
...

{
  ...
  if ( x_mm < 1 and y_mm < 1 and x<20 and y < 20)
  { 
      estado = 0;
      lcd.clear();
      lcd.setCursor(1,0);
